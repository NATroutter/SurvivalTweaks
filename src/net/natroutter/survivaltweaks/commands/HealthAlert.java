...
public class HealthAlert extends Command {
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            boolean state = database.getBoolean(p, "HealthAlert");
            if (state) {
                database.save(p, "HealthAlert", false);
                p.sendMessage(lang.Prefix + "HealthAlert: §cDisabled");
            } else {
                database.save(p, "HealthAlert", true);
                p.sendMessage(lang.Prefix + "HealthAlert: §cEnabled");
            }
